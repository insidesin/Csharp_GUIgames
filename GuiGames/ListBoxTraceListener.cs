...
namespace GuiGames {
    ...
    /// <summary>
    /// 
    /// Provides high level methods to assist in sending Trace output 
    /// to a ListBox within a GUI form.
    /// 
    /// Author: Jim Reye 
    /// 
    /// Date: March 2011
    ...
    public class ListBoxTraceListener : TraceListener {
        ...
        public override void Write(string s) {
            ...
            // Automatically scroll down to the new entry when it is added.
